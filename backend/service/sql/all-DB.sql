...
(8, 'bey', 'acadamic.bey.hu', 'mesoudmohammed393@gmail.com', 'default.jpg', '$2b$10$W6xvdZcJ6P1KSEGRehLcWOea6FmloqnWe6NlzMS4RJxbKz0kV8wAC', '0903169980', 'Buildind B', 'CCI'),
(9, 'Mohammed', 'acadamic.mohammed', 'mesoudmohammed393@gmail.com', 'default.jpg', '$2b$10$aBfBx5zGpIGyp/HvDiuiu.AL.ly9AUNc1pT/tXhwv8PBgnr0pWkHS', '0903169980', 'ee', 'Agriculture');
...
(1, 'InfoSystem', 'dept.InfoSystem', '1234567890', 'info_sys@gmail.com', 'Building C', '$2a$12$LYBOuX/eHDbUfY1L7us1xe7HMGie5mJkmvMNgIRaDVoZI8AJFqQ/m'),
...
INSERT INTO `payamout` (`id`, `department`, `amount`, `created_at`) VALUES
(7, 'InfoSystem', 3000.00, '2025-04-29 17:37:28'),
(9, 'CompScience', 3500.00, '2025-04-30 01:08:32'),
(10, 'Software', 17000.00, '2025-04-30 20:11:56'),
(11, 'InfoScience', 3000.00, '2025-04-30 20:12:19'),
(12, 'InfoTechnology', 3000.00, '2025-05-05 06:56:11');
...
(1, 'Yonas', 'bamsi', 'stud.yonas.ba', '0967155787', 'yonasda@gmail.com', 3.70, 'download.jfif', '$2a$12$LYBOuX/eHDbUfY1L7us1xe7HMGie5mJkmvMNgIRaDVoZI8AJFqQ/m', 1),
...
(6, 'Tsion', 'Ayel', 'stud.tsion.ay', '0987541377', 'tsionayu1@gmail.com', 3.90, 'default.jpg', '$2a$12$LYBOuX/eHDbUfY1L7us1xe7HMGie5mJkmvMNgIRaDVoZI8AJFqQ/m', 2),
(7, 'Abel', 'Regasa', 'stud.abel.re', '0962145677', 'abelrega@gmail.com', 3.55, 'default.jpg', '$2a$12$LYBOuX/eHDbUfY1L7us1xe7HMGie5mJkmvMNgIRaDVoZI8AJFqQ/m', 2),
...
--
ALTER TABLE `acadamic`
  MODIFY `acadamic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `placement_results`
  MODIFY `placement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=293;
